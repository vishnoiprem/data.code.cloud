...
df_cleaned.write.mode("overwrite").parquet("output/q2_result/")
...
df_sql = spark.sql("""
    SELECT *,
           CASE WHEN transaction_type IS NULL THEN 'UNKNOWN' ELSE transaction_type END AS transaction_type_fixed
    FROM transactions
""")
df_sql.write.mode("overwrite").parquet("output/q2_result_sql/")